...
import com.example.vaidi.game3.R;
import com.shephertz.app42.gaming.multiplayer.client.WarpClient;

public class Utilities {

    public static WarpClient theClient = null;
    ...
    public static final String API_KEY = "94e0ecbc59b6f51c98df75b5aaa30b81c655578fbb66a136b35b51f54af53207";
    public static final String SECRET_KEY = "b92770265c6276a23807726a946fc1978857fc2814dfac81b535aa81e2b682bd";
    ...
    public static WarpClient getWarpClient(){
        if(theClient == null){
            try {             
                ...
                theClient.initUDP();   //newly added for dynamic roomms
            } catch (Exception e) {
                e.printStackTrace();
            };
        }
